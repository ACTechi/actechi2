...
export default function AcFooter() {
    return (
        <MDBFooter bgColor='none' className='text-center text-lg-start text-muted' style={{ backgroundColor: '#77777A' }}>
            ...
            <a href='https://drive.google.com/file/d/1310s56y_hWQRz8bkI7fmq9sIPKfdtr0G/view?usp=sharing' className={styles.anchor}>Private Policy</a>
                <p>© 2023 AC Techi</p>
                <p>Use of this site is subject to our <a href='https://drive.google.com/file/d/1v7ztLT-Lx-Unp7mYPH_RzJClRMK6LEvL/view?usp=sharing' className={styles.anchor}>Terms of Use</a>.</p>
            </div>
        </MDBFooter>
    );
}